...
def show_stats():
    ...
    while True:
        ...
        window.blit(total_score_text, (SCREENSIZE[0] // 2 - 110, SCREENSIZE[1] // 4))
        window.blit(high_score_text, (SCREENSIZE[0] // 2 - 110, SCREENSIZE[1] // 4 + 50))
        window.blit(kills_text, (SCREENSIZE[0] // 2 - 110, SCREENSIZE[1] // 4 + 100))
        window.blit(hits_text, (SCREENSIZE[0] // 2 - 110, SCREENSIZE[1] // 4 + 150))
        window.blit(deaths_text, (SCREENSIZE[0] // 2 - 110 , SCREENSIZE[1] // 4 + 200))
        back_btn.draw(window)
...
while running:
    ...
    if not game_over_flag and not win_game_flag:
        ...
        window.blit(health_text, (650, SCREENSIZE[1] - 40))
